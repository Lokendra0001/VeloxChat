      ...
      <div className="min-h-[20dvh] w-[90dvw] xl:w-[65dvw] bg-border rounded-xl flex shadow-xl overflow-hidden">
        ...
        <div className="w-full md:w-1/2 h-full px-5 py-7 sm:px-10 sm:py-10 flex flex-col">
          <div className="flex items-center mb-4">
            ...
            />
            <h1 className="text-3xl font-bold text-primary">VeloxChat</h1>
          </div>
              ...
              <>
                ...
                >
                  <div className="mb-4">
                    ...
                    <div className="w-full border-2  border-gray-300  rounded-lg focus:outline-none focus:ring-2 focus:ring-[#128C7E] focus:border-transparent relative flex items-center px-1">
                      <AtSign size={20} className=" text-gray-600" />
                      <input
                        type="email"
                        className="w-full px-2 py-2  outline-none border-l border-gray-300 ml-2"
                    ...
                    {errors.loginEmail && (
                      <p className="text-red-500 mt-2 text-sm font-normal ml-1">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="w-full border-2  border-gray-300  rounded-lg focus:outline-none focus:ring-2 focus:ring-[#128C7E] focus:border-transparent relative flex items-center px-1">
                      {isPassword ? (
                        <EyeClosed
                          size={20}
                          className="text-gray-600 cursor-pointer h-full py-2 "
                      ...
                      <input
                        ...
                        className="w-full px-2 py-2 border-l border-gray-300 ml-2 outline-none"
                        placeholder="••••••••"
                  ...
                  <button className="w-full  bg-primary hover:bg-primary-hover text-white py-2 px-4 rounded-md font-medium transition-colors  shadow-md cursor-pointer flex items-center justify-center gap-1">
                    {loading ? (
                      "Login..."
                    ) : (
                      <>
                ...
                >
                  <div className="mb-4">
                    ...
                    <div className="w-full  border-2  border-gray-300  rounded-lg focus:outline-none focus:ring-2 focus:ring-[#128C7E] focus:border-transparent relative flex items-center  px-1">
                      ...
                      <input
                        type="text"
                        className="w-full px-3 py-2 outline-none border-l-2 border-gray-300 ml-2"
                    ...
                    {errors.username && (
                      <p className="text-red-400 mt-1 text-sm font-normal ml-1">
                  ...
                  <button className="w-full bg-primary hover:bg-primary text-white py-2 px-4 rounded-md font-medium transition-colors shadow-md cursor-pointer flex items-center justify-center gap-1">
                    {loading ? (
                      "Creating Account..."
                    ) : (
                      <>
